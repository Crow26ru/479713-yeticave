...
<header class="main-header">
    <div class="main-header__container container">
        ...
        <a class="main-header__logo" <?=$page_name !== 'Главная - YetiCave' ? 'href="/"' : '';?>>
        ...
        <ul class="user-menu__list">
            <li class="user-menu__item">
                <a <?=$page_name !== 'Регистрация - YetiCave' ? 'href="sign-up.php"' : '';?>>Регистрация</a>
            </li>
            <li class="user-menu__item">
                <a <?=$page_name !== 'Вход - YetiCave' ? 'href="login.php"' : '';?>>Вход</a>
            </li>
        </ul>
        <?php endif; ?>
        </nav>
...
<main <?=$page_name === 'Главная - YetiCave' ? 'class="container"' : '';?>>
    <?=$content;?>
</main>
</div>
...
<footer class="main-footer">
    <nav class="nav">
        <ul class="nav__list container">
            ...
            ?>
            <li class="nav__item">
                <a href="pages/all-lots.php?id=<?=$value['id'];?>"><?=$value['categories'];?></a>
            </li>
            <?php endforeach; ?>
        </ul>
    </nav>
    <div class="main-footer__bottom container">
        ...
        <a class="main-footer__add-lot button" <?=$page_name !== 'Добавление лота - YetiCave' ? 'href="add.php"' : '';?>>Добавить лот</a>
